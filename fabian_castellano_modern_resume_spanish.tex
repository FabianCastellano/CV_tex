...
%\end{itemize}
\cventry{2022--Actualidad}{\href{https://fabiancastellano.github.io}{fabiancastellano.github.io}}{Website Personal }{Proyecto Personal}{}{}  % arguments 3 to 6 can be left empty
\begin{itemize}
\item Desarrollo de una p\'agina web personal como portafolio, y blog sobre temas de interes.
\item Documentación de procesos de trabajo y proyectos personales. 
\end{itemize}
...
\item Estudio de la transformaci\'on de BoxCox como un paso de preprosesacimiento en un algoritmo de clasificaci\'on.
\end{itemize}
...
\cvlistdoubleitem{Microsoft Word y Excel [Intermerdio]}{}
